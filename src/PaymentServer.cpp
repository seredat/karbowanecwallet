...
const QString BITCOIN_IPC_PREFIX("elyacoin:");

static QString ipcServerName()
{
    QString name("Elyacoin");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start elyacoin: click-to-pay handler");
    else
...
{
    // clicking on elyacoin: URLs creates FileOpen events on the Mac:
